export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'bienhieupro',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Bienhieupro',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'bienhieupro.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://bienhieupro.com',
